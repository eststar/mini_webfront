...
export default function BoardView() {
    ...
    // 🦾 중요: 로딩 중일 때는 null을 리턴해서 MainPage의 AnimatePresence가 대기하게 만든다.
                            ...
                            {filteredBoard.map((post) => (
                                ...
                                >
                                    ...
                                    <div className="md:col-span-3 flex items-center md:items-end md:justify-center justify-between mt-2 md:mt-0">
                                        ...
                                        <span className="text-slate-400 font-black text-[9px] md:hidden tracking-tighter italic">2025.12.30</span>
                                    </div>
                                </motion.div>
                            ))}
                        </AnimatePresence>
